            ...
            <div class="main-holder">
                <div class="container-fluid">
                    ...
                    <div class="step-tab step-4">
                                <h2 class="ttl ttl-add">Congratulations!</h2>
                                <div class="entry">
                                    <h4>You have completed your loan offer.</h4>
                                    <p>We are reviewing your loan offer, this may take up to 48 hours to finalize and disburse your loan. In the meantime, watch your inbox as we will get back to you on our final decision.</p>
